...
type FirestoreIndexRef struct {
	...
	// The namespace of a FirestoreIndex resource.
	Namespace string `json:"namespace,omitempty"`
}

func init() {
	refs.Register(&FirestoreIndexRef{}, &FirestoreIndexIdentity{})
}

func (r *FirestoreIndexRef) GetGVK() schema.GroupVersionKind {
	return FirestoreIndexGVK
}

func (r *FirestoreIndexRef) GetNamespacedName() types.NamespacedName {
...
func (r *FirestoreIndexRef) GetExternal() string {
	return r.External
}
...
func (r *FirestoreIndexRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &FirestoreIndexIdentity{}
...
func (r *FirestoreIndexRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		identity, err := getIdentityFromFirestoreIndexSpec(ctx, reader, u)
		if err != nil {
			return ""
		}
