...
func (in *DataStoreRef) DeepCopyInto(out *DataStoreRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataStoreRef.
func (in *DataStoreRef) DeepCopy() *DataStoreRef {
	if in == nil {
		return nil
	}
	out := new(DataStoreRef)
	in.DeepCopyInto(out)
	return out
}
