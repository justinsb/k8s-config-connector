...
import (
	...
	extMetricsscopepb "cloud.google.com/go/monitoring/metricsscope/apiv1/metricsscopepb"
...
func request_MetricsScopes_GetMetricsScope_0(ctx context.Context, marshaler runtime.Marshaler, client extMetricsscopepb.MetricsScopesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extMetricsscopepb.GetMetricsScopeRequest
...
func local_request_MetricsScopes_GetMetricsScope_0(ctx context.Context, marshaler runtime.Marshaler, server extMetricsscopepb.MetricsScopesServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extMetricsscopepb.GetMetricsScopeRequest
	var metadata runtime.ServerMetadata
...
func request_MetricsScopes_ListMetricsScopesByMonitoredProject_0(ctx context.Context, marshaler runtime.Marshaler, client extMetricsscopepb.MetricsScopesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extMetricsscopepb.ListMetricsScopesByMonitoredProjectRequest
	var metadata runtime.ServerMetadata
...
func local_request_MetricsScopes_ListMetricsScopesByMonitoredProject_0(ctx context.Context, marshaler runtime.Marshaler, server extMetricsscopepb.MetricsScopesServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extMetricsscopepb.ListMetricsScopesByMonitoredProjectRequest
	var metadata runtime.ServerMetadata
...
func request_MetricsScopes_CreateMonitoredProject_0(ctx context.Context, marshaler runtime.Marshaler, client extMetricsscopepb.MetricsScopesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extMetricsscopepb.CreateMonitoredProjectRequest
	var metadata runtime.ServerMetadata
...
func local_request_MetricsScopes_CreateMonitoredProject_0(ctx context.Context, marshaler runtime.Marshaler, server extMetricsscopepb.MetricsScopesServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extMetricsscopepb.CreateMonitoredProjectRequest
	var metadata runtime.ServerMetadata
...
func request_MetricsScopes_DeleteMonitoredProject_0(ctx context.Context, marshaler runtime.Marshaler, client extMetricsscopepb.MetricsScopesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extMetricsscopepb.DeleteMonitoredProjectRequest
	var metadata runtime.ServerMetadata
...
func local_request_MetricsScopes_DeleteMonitoredProject_0(ctx context.Context, marshaler runtime.Marshaler, server extMetricsscopepb.MetricsScopesServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extMetricsscopepb.DeleteMonitoredProjectRequest
	var metadata runtime.ServerMetadata
...
func RegisterMetricsScopesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extMetricsscopepb.MetricsScopesServer) error {
	...
	mux.Handle("GET", pattern_MetricsScopes_GetMetricsScope_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.monitoring.metricsscope.v1.MetricsScopes/GetMetricsScope", runtime.WithHTTPPathPattern("/v1/{name=locations/global/metricsScopes/*}"))
		if err != nil {
	...
	mux.Handle("GET", pattern_MetricsScopes_ListMetricsScopesByMonitoredProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.monitoring.metricsscope.v1.MetricsScopes/ListMetricsScopesByMonitoredProject", runtime.WithHTTPPathPattern("/v1/locations/global/metricsScopes:listMetricsScopesByMonitoredProject"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetricsScopes_CreateMonitoredProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.monitoring.metricsscope.v1.MetricsScopes/CreateMonitoredProject", runtime.WithHTTPPathPattern("/v1/{parent=locations/global/metricsScopes/*}/projects"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_MetricsScopes_DeleteMonitoredProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.monitoring.metricsscope.v1.MetricsScopes/DeleteMonitoredProject", runtime.WithHTTPPathPattern("/v1/{name=locations/global/metricsScopes/*/projects/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMetricsScopesHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterMetricsScopesHandlerClient(ctx, mux, extMetricsscopepb.NewMetricsScopesClient(conn))
}

// RegisterMetricsScopesHandlerClient registers the http handlers for service MetricsScopes
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extMetricsscopepb.MetricsScopesClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "extMetricsscopepb.MetricsScopesClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "extMetricsscopepb.MetricsScopesClient" to call the correct interceptors.
func RegisterMetricsScopesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extMetricsscopepb.MetricsScopesClient) error {
	...
	mux.Handle("GET", pattern_MetricsScopes_GetMetricsScope_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.monitoring.metricsscope.v1.MetricsScopes/GetMetricsScope", runtime.WithHTTPPathPattern("/v1/{name=locations/global/metricsScopes/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MetricsScopes_ListMetricsScopesByMonitoredProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.monitoring.metricsscope.v1.MetricsScopes/ListMetricsScopesByMonitoredProject", runtime.WithHTTPPathPattern("/v1/locations/global/metricsScopes:listMetricsScopesByMonitoredProject"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetricsScopes_CreateMonitoredProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.monitoring.metricsscope.v1.MetricsScopes/CreateMonitoredProject", runtime.WithHTTPPathPattern("/v1/{parent=locations/global/metricsScopes/*}/projects"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_MetricsScopes_DeleteMonitoredProject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.monitoring.metricsscope.v1.MetricsScopes/DeleteMonitoredProject", runtime.WithHTTPPathPattern("/v1/{name=locations/global/metricsScopes/*/projects/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
