...
/*
Package apikeys is a reverse proxy.
...
func RegisterApiKeysHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ApiKeysServer) error {
	...
	mux.Handle("POST", pattern_ApiKeys_CreateKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/CreateKey", runtime.WithHTTPPathPattern("/v2/{parent=projects/*/locations/*}/keys"))
		if err != nil {
	...
	mux.Handle("GET", pattern_ApiKeys_ListKeys_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/ListKeys", runtime.WithHTTPPathPattern("/v2/{parent=projects/*/locations/*}/keys"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ApiKeys_GetKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/GetKey", runtime.WithHTTPPathPattern("/v2/{name=projects/*/locations/*/keys/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ApiKeys_GetKeyString_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/GetKeyString", runtime.WithHTTPPathPattern("/v2/{name=projects/*/locations/*/keys/*}/keyString"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_ApiKeys_UpdateKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/UpdateKey", runtime.WithHTTPPathPattern("/v2/{key.name=projects/*/locations/*/keys/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_ApiKeys_DeleteKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/DeleteKey", runtime.WithHTTPPathPattern("/v2/{name=projects/*/locations/*/keys/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ApiKeys_UndeleteKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/UndeleteKey", runtime.WithHTTPPathPattern("/v2/{name=projects/*/locations/*/keys/*}:undelete"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ApiKeys_LookupKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/LookupKey", runtime.WithHTTPPathPattern("/v2/keys:lookupKey"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterApiKeysHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ApiKeysClient) error {
	...
	mux.Handle("POST", pattern_ApiKeys_CreateKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/CreateKey", runtime.WithHTTPPathPattern("/v2/{parent=projects/*/locations/*}/keys"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ApiKeys_ListKeys_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/ListKeys", runtime.WithHTTPPathPattern("/v2/{parent=projects/*/locations/*}/keys"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ApiKeys_GetKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/GetKey", runtime.WithHTTPPathPattern("/v2/{name=projects/*/locations/*/keys/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ApiKeys_GetKeyString_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/GetKeyString", runtime.WithHTTPPathPattern("/v2/{name=projects/*/locations/*/keys/*}/keyString"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_ApiKeys_UpdateKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/UpdateKey", runtime.WithHTTPPathPattern("/v2/{key.name=projects/*/locations/*/keys/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_ApiKeys_DeleteKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/DeleteKey", runtime.WithHTTPPathPattern("/v2/{name=projects/*/locations/*/keys/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ApiKeys_UndeleteKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/UndeleteKey", runtime.WithHTTPPathPattern("/v2/{name=projects/*/locations/*/keys/*}:undelete"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ApiKeys_LookupKey_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.apikeys.v2.ApiKeys/LookupKey", runtime.WithHTTPPathPattern("/v2/keys:lookupKey"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
