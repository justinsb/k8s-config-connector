...
* **Kind**: `LoggingLogView`
* **Current Step**: Step 3: Create a Round-Trip KRM Fuzzer (PR approved, waiting for merge)
...
| 3 | Create a Round-Trip KRM Fuzzer | [#8997](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/8997) | [#8998](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/8998) | `PR Created` | 2026-06-02 | - |
