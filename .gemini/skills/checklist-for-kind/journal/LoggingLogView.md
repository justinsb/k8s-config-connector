...
* **Kind**: `LoggingLogView`
* **Current Step**: Step 1: Direct API Types (PR open, waiting for merge)

## Progress Tracker

| Step | Description | Issue | PR | Status | Started | Completed |
|---|---|---|---|---|---|---|
| 1 | Direct API Types & generate.sh | [#8971](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/8971) | [#8973](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/8973) | `PR Created` | 2026-06-02 | - |
| 2 | Identity and Reference Types | [#8970](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/8970) | - | `Open` | 2026-06-02 | - |
