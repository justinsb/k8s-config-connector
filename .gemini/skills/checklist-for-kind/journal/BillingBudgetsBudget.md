...
|---|---|---|---|---|---|---|
| 1 | Direct API Types & generate.sh | [#9013](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/9013) | [#9025](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9025) | `Completed` | 2026-06-02 | 2026-06-03 |
...
* **2026-06-03**: Pull Request [#9025](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9025) merged successfully. Marked Step 1 as `Completed`.
