...
import (
	...
	krm "github.com/GoogleCloudPlatform/k8s-config-connector/apis/billingbudgets/v1alpha1"
...
func BudgetAmount_FromProto(mapCtx *direct.MapContext, in *pb.BudgetAmount) *krm.BudgetAmount {
	...
	out.SpecifiedAmount = BudgetAmount_SpecifiedAmount_FromProto(mapCtx, in.GetSpecifiedAmount())
...
func BudgetAmount_ToProto(mapCtx *direct.MapContext, in *krm.BudgetAmount) *pb.BudgetAmount {
	...
	out := &pb.BudgetAmount{}
	if oneof := BudgetAmount_SpecifiedAmount_ToProto(mapCtx, in.SpecifiedAmount); oneof != nil {
...
func CustomPeriod_FromProto(mapCtx *direct.MapContext, in *pb.CustomPeriod) *krm.CustomPeriod {
	...
	out.StartDate = CustomPeriod_StartDate_FromProto(mapCtx, in.GetStartDate())
	out.EndDate = CustomPeriod_EndDate_FromProto(mapCtx, in.GetEndDate())
	return out
}
func CustomPeriod_ToProto(mapCtx *direct.MapContext, in *krm.CustomPeriod) *pb.CustomPeriod {
	...
	out := &pb.CustomPeriod{}
	out.StartDate = CustomPeriod_StartDate_ToProto(mapCtx, in.StartDate)
	out.EndDate = CustomPeriod_EndDate_ToProto(mapCtx, in.EndDate)
	return out
}
